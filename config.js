...
STICKER_NAME: process.env.STICKER_NAME || "Sʜᴀᴅᴏᴡ-Xᴛᴇᴄʜ",
...
OWNER_NAME: process.env.OWNER_NAME || "✨ Kelly S Kay✨",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© Pᴏᴡᴇʀᴇᴅ Bʏ Sʜᴀᴅᴏᴡ-Xᴛᴇᴄʜ*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/w6mzc7.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> Am Active *Sʜᴀᴅᴏᴡ-Xᴛᴇᴄʜ*⚡",
// add alive msg here 
...
DEV: process.env.DEV || "27813522157",
